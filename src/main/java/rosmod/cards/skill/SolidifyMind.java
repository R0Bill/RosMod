...
public class SolidifyMind extends BaseCard {
    public static final String ID = makeID("SolidifyMind"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
