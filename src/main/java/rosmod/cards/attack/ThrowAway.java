...
public class ThrowAway extends BaseCard {//造成5点伤害，抽一张牌，升级，0费，抽两张
    public static final String ID = makeID("ThrowAway"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
