...
public class StealBlock extends BaseCard {//偷盾，升级，抽一张牌
    public static final String ID = makeID("StealBlock"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
